...
- [DMA Attack](overviews/dma-attack.md) — [[memory-acquisition-path]] initiator/transport classification; PCIe DMA threat model (cheat PC + FPGA + HID); three defense layers + assurance boundaries; device evidence dimensions; layered detection + TPM attestation; Thunderbolt/USB4; Cheat (~2807) / Detection:DMA (~727) + [[aetheris]]/[[luminary-dma]] MemProcFS forensics + WSF ~10 [[windows-runtime-attestation-report]]
...
- [KSword](entities/ksword.md) — Qt ARK with custom kernel driver (process/kernel object/memory/driver/callback/SSDT panels; Win32 API monitor; CE plugin; VirusTotal/ThreatBook; KSwordDEV; Cheat / Windows Kernel Explorer)
